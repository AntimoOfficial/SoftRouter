...
for file in diagnose.sh diagnostics/lib.sh tests/test-diagnostics.sh gateway.sh gatewayctl config.sh install.sh tests/run.sh tests/test-config.sh tests/test-daemon.sh tests/test-install.sh tools/package.sh; do
...
/bin/bash "$BASE/tests/test-install.sh"
/bin/bash "$BASE/tests/test-diagnostics.sh"
