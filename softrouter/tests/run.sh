...
for file in gateway.sh gatewayctl config.sh install.sh tests/run.sh tests/test-config.sh tests/test-daemon.sh tests/test-install.sh tools/package.sh; do
