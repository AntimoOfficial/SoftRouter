...
with tempfile.TemporaryDirectory(prefix='air-gateway-pkg-check-') as temp:
    ...
    assert info.get('identifier') == 'org.airgateway.installer'
    ...
    app = payload / 'Applications/Air Gateway.app'
    assert app.is_dir()
